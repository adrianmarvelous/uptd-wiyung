...
<html lang="en">
  <head>
    ...
    <link
      rel="icon"
      href="{{ asset('templetes/kaiadmin-lite/assets/img/kaiadmin/favicon.ico')}}"
      type="image/x-icon"
    />
  ...
  <body>
    ...
    <!-- jQuery Sparkline -->
    <script src="{{ asset('templetes/kaiadmin-lite/assets/js/plugin/jquery.sparkline/jquery.sparkline.min.js')}}"></script>
    ...
    <!-- Bootstrap Notify -->
    <script src="{{ asset('templetes/kaiadmin-lite/assets/js/plugin/bootstrap-notify/bootstrap-notify.min.js')}}"></script>
